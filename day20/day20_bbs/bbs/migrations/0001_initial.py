    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bbs.User_Login')),
            ],
        ),
        migrations.AddField(
            model_name='thumbup',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbs.UserInfo'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
        ...
        migrations.AddField(
            model_name='category',
            name='category_admin',
            field=models.ManyToManyField(to='bbs.UserInfo'),
        ),
        migrations.AddField(
            model_name='article',
            name='author',
